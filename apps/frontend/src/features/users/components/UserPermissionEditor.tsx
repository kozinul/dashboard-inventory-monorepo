...
const RESOURCES = [
    ...
    { id: 'inventory', label: 'Master Inventory', actions: ['view', 'create', 'edit', 'delete'] },
    { id: 'panels', label: 'Panels & Racks', actions: ['view', 'create', 'edit', 'delete'] },
    { id: 'incoming', label: 'Incoming Items', actions: ['view', 'create', 'edit', 'delete'] },
    { id: 'transfer', label: 'Transfer', actions: ['view', 'create', 'edit', 'delete'] },
    ...
    { id: 'maintenance', label: 'Maintenance', actions: ['view', 'create', 'edit', 'delete'] },
    { id: 'my_tickets', label: 'My Tickets', actions: ['view', 'create', 'edit', 'delete'] },
    { id: 'dept_tickets', label: 'Dept. Tickets', actions: ['view', 'create', 'edit', 'delete'] },
    { id: 'assigned_tickets', label: 'Assigned Tickets', actions: ['view', 'create', 'edit'] },
    { id: 'services', label: 'External Services', actions: ['view', 'create', 'edit', 'delete'] },
